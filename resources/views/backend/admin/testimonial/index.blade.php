            ...
            <div class="col-12">
                <div class="card card-info card-outline">
                    <div class="card-header">
                        <h3 class="card-title float-left">Testimonial List</h3>
                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            @foreach($testimonials as $key => $testimonial)
                                <tr>
                                    <td>{{$key + 1}}</td>
                                    <td>
                                        <img src="{{url($testimonial->image)}}" width="80" height="40" alt="">
                                    </td>
                                    <td>{{$testimonial->details}}</td>
                                    <td>
                                        <a class="btn btn-info waves-effect" href="{{route('admin.testimonials.edit',$testimonial->id)}}">
                                            <i class="fa fa-edit"></i>
                                        </a>
                                        <button class="btn btn-danger waves-effect" type="button"
                                                onclick="deletePost({{$testimonial->id}})">
