...
@section("title","Project Image Show")
@push('css')
...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Project Image Show</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}">Home</a></li>
                        <li class="breadcrumb-item active">Project Image Show</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
            ...
            <div class="col-12">
                ...
                <div class="card card-info card-outline">
                    <div class="card-header">
                        <h3 class="card-title float-left">Project Image Show</h3>
                                    ...
                                    <div class="card col-md-2 m-1">
                                        <div class="card-header">
                                            <div class="card-title">
                                                ...
                                                <form id="delete-form-{{$gallery->id}}" action="{{route('project-gallery.delete',$gallery->id)}}" method="POST" style="display: none;">
                                                    @csrf
                                                    @method('DELETE')
                                                </form>
                                            </div>
                                        ...
                                        <div class="card-body" >
                                            <img class="img-thumbnail" src="{{asset('uploads/project/gallery/'.$gallery->image)}}" style="height: 80px" alt="">
                                        </div>
                                    </div>
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form role="form" action="{{route('project-gallery.update',$gallery->id)}}" method="post" enctype="multipart/form-data">
                                                        @csrf
                                                        @method('PUT')
    ...
    <div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form role="form" action="{{route('project-gallery.store')}}" method="post" enctype="multipart/form-data">
                        @csrf
