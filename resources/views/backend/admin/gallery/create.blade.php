                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="form-group col-md-8">
                                    ...
                                    <input type="text" class="form-control" name="title" placeholder="Enter Image Title" id="image">
                                </div>
                            </div>
                            <div class="row">
...
{{--                                    <input type="url" class="form-control" name="url" placeholder="url" id="image">--}}
{{--                                </div>--}}
{{--                            </div>--}}
