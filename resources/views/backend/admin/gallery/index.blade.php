            ...
            <div class="col-12">
                <div class="card card-info card-outline">
                    <div class="card-header">
                        <h3 class="card-title float-left">Image List</h3>
                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            @foreach($galleries as $key => $gallery)
                                <tr>
                                    ...
                                    <td>{{$gallery->title}}</td>
                                    <td>
                                        <img src="{{url($gallery->image)}}" width="80" height="40" alt="">
                                    </td>
                                    <td>
                                        <a class="btn btn-info waves-effect" href="{{route('admin.gallery.edit',$gallery->id)}}">
