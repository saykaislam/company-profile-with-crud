                            ...
                            @foreach($customers as $key => $customer)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a class="btn btn-info waves-effect" href="{{route('admin.customer.show',$customer->id)}}">
                                            <i class="fa fa-eye"></i>
                                        </a>
                                        <a class="btn btn-info waves-effect" href="{{route('admin.customer.edit',$customer->id)}}">
                                            <i class="fa fa-edit"></i>
                                        </a>

                                        <button class="btn btn-danger waves-effect" type="button"
                                                onclick="deletePost({{$customer->id}})">
